...
<style>
  ...
  .border-right {
    border-right: 4px solid #5858ff;
  }
  .border-bottom {
    border-bottom: 4px solid #5858ff;
  }
  .border-top {
    border-top: 4px solid #5858ff;
  }
  .sub-items {
    height: 28px;
    width: 28px;
  ...
  @keyframes swing {
    50% { transform: rotateZ(10deg) scale(0.4); }
  }
  @keyframes flash {
    50% { border-color: #485563; }
  }
</style>
